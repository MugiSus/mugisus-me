...
// 3D simplex noise by Ian McEwan, Ashima Arts, and Stefan Gustavson (MIT).
...
void main() {
  // The asymmetric sub-pixel offset avoids the simplex implementation's
  // ambiguous ordering at an exact lattice corner; the field moves by <= 0.002px.
  vec2 pixelPosition =
